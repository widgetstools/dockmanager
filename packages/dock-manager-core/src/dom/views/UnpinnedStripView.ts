...
export class UnpinnedStripView {
  ...
  private openFlyout(panelId: string): void {
    ...
    pinBtn.style.cssText = 'padding:4px;color:hsl(var(--dock-text-muted));cursor:pointer;background:none;border:none;display:flex;align-items:center;';
    ...
    closeBtn.style.cssText = 'padding:4px;color:hsl(var(--dock-text-muted));cursor:pointer;background:none;border:none;display:flex;align-items:center;';
